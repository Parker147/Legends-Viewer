...
namespace LegendsViewer.Legends
{
    public class HistoricalFigure : WorldObject
    {
            ...
            : base(properties, world)
        {
            ...
            List<string> knownRelationshipProfileProperties = new List<string>() { "hf_id", "known_identity_id", "meet_count", "last_meet_year", "last_meet_seconds72", "rep_friendly", "rep_buddy", "rep_grudge", "rep_bonded", "rep_quarreler", "rep_trade_partner" };
