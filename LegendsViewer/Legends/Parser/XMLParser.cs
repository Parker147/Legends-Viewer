        ...
        public void AddFromXMLSection(Section section, List<Property> properties)
        {
            try
            {
                switch (section)
                {
                    ...
                    case Section.WorldConstructions: World.WorldConstructions.Add(new WorldConstruction(properties, World)); break;
        ...
        private void AddEvent(string type, List<Property> properties)
        {
            try
            {
                switch (type)
                {
                    ...
                    case "hf disturbed structure": World.Events.Add(new HFDisturbedStructure(properties, World)); break;
                    default:
