...
namespace LegendsViewer
{
    public static class AppHelpers
    {
        ...
        new string[] {"add hf entity link",           "Historical Figure - Entity Link",          "Enemy / Prisoner / Member / General / King / Queen / Etc."},
        new string[] {"add hf hf link",               "Historical Figure Links",                  "Marriage / Imprisonment / Worship"},
        new string[] {"attacked site",                "Site Attacked",                            ""},
        new string[] {"body abused",                  "Historical Figure Body Abused",            "Mutilation / Impalement / Hanging"},
        new string[] {"change hf job",                "Historical Figure Change Job",             ""},
        new string[] {"change hf state",              "Historical Figure Change State",           "Scouting / Wandering / Snatcher / Thief / Refugee"},
        new string[] {"changed creature type",        "Historical Figure Transformed",            "Transformed into race / caste of abducter"},
        new string[] {"create entity position",       "Entity Position Created",                  ""},
        new string[] {"created site",                 "Site Founded",                             ""},
        new string[] {"created world construction",   "Entity Construction Created",              "Road / Bridges / Tunnels connecting two sites"},
        new string[] {"creature devoured",            "Historical Figure Eaten",                  "",},
        ...
        new string[] {"hf new pet",                   "Historical Figure Tamed Creatures",        "Tamed creatures in region"},
        ...
        new string[] {"add hf site link",             "Historical Figure - Site Link",            "Historical Figure started living at site"},
        new string[] {"created structure",            "Site Structure Created",                   "Some sort of structure created"},
        new string[] {"hf razed structure",           "Site Structure Razed",                     ""},
        new string[] {"remove hf site link",          "Historical Figure - Site Link Removed",    "Historical Figure moved out of site"},
        new string[] {"replaced structure",           "Site Structure Replaced",                  "Housing replaced with biggger housing"},
